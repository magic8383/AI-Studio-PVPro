    ...
    <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
        ...
        <div id="acc_bg4" class="acc-content px-5 pb-5 text-sm text-slate-600 dark:text-slate-300 border-t border-slate-100 dark:border-slate-800">
            ...
            <ul class="space-y-3 mt-2">
                <li><strong>v8.0.1 (Current):</strong> Katalog-Initialisierung & Ausstattungs-Pool Fix, PWA-Cache-Erneuerung & Icon-Aktualisierungslogik. Behebung des leeren Hardware-Katalogs durch unmittelbare Vorinitialisierung der Stammdaten (AIKO Neostar 2S+, Fronius Symo GEN24 Plus SC, Hoymiles HMS-1600/1800/2000T-4T und BYD HVS+) sowie robuste Fallback-Absicherung in <code>renderDatabaseUI()</code> und <code>renderHardwareCatalogUI()</code>. Bereitstellung der fehlenden Ausstattungs-Pool-Handler (<code>onSelectActivePanel</code>, <code>onSelectActiveInverter</code>) im globalen Scope. Service Worker Cache auf <code>pvpro-cache-v8.0.1</code> aktualisiert und PWA-Manifest/Icon-Cache-Buster integriert, sodass Browser- und OS-Zwischenspeicher für App-Icons und Offline-Skripte gezielt invalidiert werden.</li>

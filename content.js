    ...
    <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
        ...
        <div id="acc_bg4" class="acc-content px-5 pb-5 text-sm text-slate-600 dark:text-slate-300 border-t border-slate-100 dark:border-slate-800">
            ...
            <ul class="space-y-3 mt-2">
                <li><strong>v7.8.0 (Current):</strong> Header-Aufräumung & App-weite Mobile-First-Optimierung. Entfernung des überflüssigen „Material Expressive“-Labels aus der Statusleiste. Einführung eines ergonomischen mobilen Dropdown-Untermenüs für sekundäre Optionen (Theme, Reset, Handbuch). Umfassendes Mobile-Audit mit Beseitigung von Text- und Card-Overflows (Strings, Verkabelungs-Toolbar mit horizontalem Scrollen, Monats-Detailansicht, M3 More Sheet mit max-height und Scrollbar). Verankerung der verbindlichen Mobile-First-Richtlinie im Entwicklerleitfaden (<code>DEVELOPMENT_GUIDELINES.md</code>).</li>
